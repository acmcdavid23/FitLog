        ...
        public static async Task Main(string[] args)
        {
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                if (!context.SupplementLibraryItems.Any())
                {
                    ...
                    {
                        new SupplementLibraryItem { Name = "Creatine Monohydrate", Category = "Performance", EvidenceLevel = "Strong", RecommendedDosage = "3-5g daily", WhenToTake = "Any time, consistency matters most", Description = "Creatine is the most researched supplement in sports nutrition. It increases phosphocreatine stores in muscles, allowing for greater ATP production during high-intensity exercise.", Benefits = "Increased strength and power output\nImproved muscle mass over time\nEnhanced high-intensity exercise performance\nMay improve recovery between sets\nCognitive benefits in some populations", InfoUrl = "https://examine.com/supplements/creatine/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Caffeine", Category = "Performance", EvidenceLevel = "Strong", RecommendedDosage = "3-6mg per kg bodyweight", WhenToTake = "30-60 minutes before training", Description = "Caffeine is a stimulant that blocks adenosine receptors, reducing perceived fatigue and increasing alertness and performance.", Benefits = "Increased strength and endurance\nReduced perceived effort during exercise\nImproved focus and alertness\nEnhanced fat oxidation during exercise", InfoUrl = "https://examine.com/supplements/caffeine/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Beta-Alanine", Category = "Performance", EvidenceLevel = "Strong", RecommendedDosage = "3.2-6.4g daily", WhenToTake = "Split into multiple doses throughout the day", Description = "Beta-alanine increases muscle carnosine levels, buffering acid buildup during intense exercise and delaying fatigue.", Benefits = "Delayed muscular fatigue\nImproved endurance in 1-4 minute efforts\nIncreased training volume capacity\nMay cause harmless tingling sensation (paresthesia)", InfoUrl = "https://examine.com/supplements/beta-alanine/", IsRecommended = false },
                        new SupplementLibraryItem { Name = "Citrulline Malate", Category = "Performance", EvidenceLevel = "Moderate", RecommendedDosage = "6-8g", WhenToTake = "30-60 minutes before training", Description = "Citrulline increases arginine and nitric oxide levels, improving blood flow and reducing fatigue during exercise.", Benefits = "Improved blood flow and muscle pumps\nReduced muscle soreness\nIncreased training volume\nMay improve aerobic and anaerobic performance", InfoUrl = "https://examine.com/supplements/citrulline/", IsRecommended = false },
                        new SupplementLibraryItem { Name = "Whey Protein", Category = "Recovery", EvidenceLevel = "Strong", RecommendedDosage = "20-40g per serving", WhenToTake = "Post-workout or any time to hit protein goals", Description = "Whey protein is a fast-digesting complete protein derived from milk. It provides all essential amino acids and is ideal for muscle protein synthesis.", Benefits = "Supports muscle protein synthesis\nConvenient way to hit daily protein targets\nFast absorption makes it ideal post-workout\nHigh in leucine which triggers muscle growth", InfoUrl = "https://examine.com/supplements/whey-protein/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Magnesium", Category = "Recovery", EvidenceLevel = "Moderate", RecommendedDosage = "200-400mg", WhenToTake = "Before bed", Description = "Magnesium is involved in over 300 enzymatic reactions in the body. Many athletes are deficient due to sweat losses.", Benefits = "Improved sleep quality\nReduced muscle cramps\nSupports energy production\nMay reduce cortisol levels\nSupports bone health", InfoUrl = "https://examine.com/supplements/magnesium/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Tart Cherry Extract", Category = "Recovery", EvidenceLevel = "Moderate", RecommendedDosage = "480mg or 8-12oz juice", WhenToTake = "Post-workout or before bed", Description = "Tart cherry is rich in anthocyanins and has potent anti-inflammatory and antioxidant properties that support recovery.", Benefits = "Reduced muscle soreness\nDecreased inflammation markers\nImproved sleep quality\nMay reduce upper respiratory symptoms", InfoUrl = "https://examine.com/supplements/tart-cherry/", IsRecommended = false },
                        new SupplementLibraryItem { Name = "Ashwagandha", Category = "Recovery", EvidenceLevel = "Moderate", RecommendedDosage = "300-600mg KSM-66 extract", WhenToTake = "Morning or before bed", Description = "Ashwagandha is an adaptogen that helps the body manage stress. It has shown benefits for strength, recovery, and hormonal balance.", Benefits = "Reduced cortisol and stress\nImproved strength and muscle mass\nBetter sleep quality\nMay support testosterone levels\nImproved VO2 max", InfoUrl = "https://examine.com/supplements/ashwagandha/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Vitamin D3", Category = "Vitamins & Minerals", EvidenceLevel = "Strong", RecommendedDosage = "1000-4000 IU daily", WhenToTake = "With a meal containing fat", Description = "Vitamin D3 is essential for bone health, immune function, and hormonal balance. Most people in northern climates are deficient.", Benefits = "Bone health and calcium absorption\nImmune system support\nMay support testosterone production\nImproved mood and reduced depression risk\nReduced injury risk", InfoUrl = "https://examine.com/supplements/vitamin-d/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Omega-3 Fish Oil", Category = "Health", EvidenceLevel = "Strong", RecommendedDosage = "1-3g EPA+DHA daily", WhenToTake = "With meals", Description = "Omega-3 fatty acids EPA and DHA support cardiovascular health, reduce inflammation, and may improve body composition.", Benefits = "Reduced inflammation\nCardiovascular health support\nMay reduce muscle soreness\nJoint health support\nCognitive health benefits", InfoUrl = "https://examine.com/supplements/fish-oil/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Zinc", Category = "Vitamins & Minerals", EvidenceLevel = "Moderate", RecommendedDosage = "25-45mg daily", WhenToTake = "Before bed or with meals", Description = "Zinc is essential for testosterone production, immune function, and protein synthesis. Athletes often have higher needs due to sweat losses.", Benefits = "Supports testosterone production\nImmune system function\nProtein synthesis support\nWound healing\nReduced exercise-induced immune suppression", InfoUrl = "https://examine.com/supplements/zinc/", IsRecommended = false },
                        new SupplementLibraryItem { Name = "Vitamin C", Category = "Vitamins & Minerals", EvidenceLevel = "Moderate", RecommendedDosage = "500-1000mg daily", WhenToTake = "With meals, split doses", Description = "Vitamin C is a potent antioxidant that supports immune function, collagen synthesis, and may reduce exercise-induced oxidative stress.", Benefits = "Immune system support\nCollagen synthesis for joints and tendons\nAntioxidant protection\nMay reduce duration of colds\nSupports iron absorption", InfoUrl = "https://examine.com/supplements/vitamin-c/", IsRecommended = false },
                        new SupplementLibraryItem { Name = "Protein Powder", Category = "Weight Management", EvidenceLevel = "Strong", RecommendedDosage = "20-40g per serving as needed", WhenToTake = "Any time to hit protein goals", Description = "High protein intake supports satiety, preserves muscle during a caloric deficit, and increases thermic effect of food.", Benefits = "Increased satiety and reduced hunger\nMuscle preservation during fat loss\nHigher thermic effect than carbs or fats\nConvenient way to increase protein intake", InfoUrl = "https://examine.com/supplements/whey-protein/", IsRecommended = true },
                        new SupplementLibraryItem { Name = "Green Tea Extract", Category = "Weight Management", EvidenceLevel = "Moderate", RecommendedDosage = "400-500mg EGCG daily", WhenToTake = "Before exercise or with meals", Description = "Green tea extract contains EGCG and caffeine which work synergistically to increase fat oxidation and metabolic rate.", Benefits = "Modest increase in metabolic rate\nEnhanced fat oxidation\nAntioxidant benefits\nMay improve insulin sensitivity", InfoUrl = "https://examine.com/supplements/green-tea-extract/", IsRecommended = false },
                        new SupplementLibraryItem { Name = "Fiber Supplement", Category = "Weight Management", EvidenceLevel = "Strong", RecommendedDosage = "10-15g additional fiber daily", WhenToTake = "With meals or before meals", Description = "Adequate fiber intake supports satiety, gut health, and blood sugar regulation � all important for weight management.", Benefits = "Increased satiety and reduced calorie intake\nImproved gut health\nBetter blood sugar control\nReduced cholesterol levels", InfoUrl = "https://examine.com/supplements/psyllium/", IsRecommended = false },
                    };
